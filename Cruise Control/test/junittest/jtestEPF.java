...
public class jtestEPF {
	...
	public void testsimulate() throws IOException {
		try{
			...
			FileReader fr=new FileReader("E:/Courses/SYSC5105/Sysc5105project/Sysc5105project/All test suites and expected output/EdgePairFaster.txt");
            BufferedReader br=new BufferedReader(fr);
            FileReader frr=new FileReader("E:/Courses/SYSC5105/Sysc5105project/Sysc5105project/All test suites and expected output/EdgePairFasterOracle.txt");
